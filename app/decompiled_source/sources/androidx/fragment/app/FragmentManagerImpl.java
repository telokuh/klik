    ...
    public void moveToState(Fragment f, int newState, int transit, int transitionStyle, boolean keepActive) {
        ...
        if (f.mState <= newState3) {
            ...
            if (i != 0) {
                ...
                f.mFragmentManager = fragment != null ? fragment.mChildFragmentManager : fragmentHostCallback.mFragmentManager;
                if (f.mTarget == null) {
                    str = "Fragment ";
                ...
                if (f.mTargetWho != null) {
                    ...
                    if (target3 == null) {
                        throw new IllegalStateException(str + f + str2 + f.mTargetWho + " that does not belong to this FragmentManager!");
        ...
        if ("fragment".equals(name)) {
            ...
            if (containerId != -1 || id != -1 || tag != null) {
                ...
                if (fragment2 == null) {
                    ...
                    fragment2.onInflate(fragmentHostCallback2.getContext(), attrs, fragment2.mSavedFragmentState);
                    fragment = fragment2;
                }
