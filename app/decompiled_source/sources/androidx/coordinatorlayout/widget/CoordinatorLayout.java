    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        while (i2 < childCount2) {
            ...
            if (child.getVisibility() == 8) {
                ...
                widthUsed4 = Math.max(heightUsed2, heightPadding + widthUsed6 + lp.topMargin + lp.bottomMargin);
                int heightUsed7 = child.getMeasuredState();
                heightUsed4 = View.combineMeasuredStates(childState2, heightUsed7);
        ...
        int childState4 = heightUsed4;
        int childState5 = widthUsed4;
        int heightUsed8 = childState3;
        int width = View.resolveSizeAndState(heightUsed8, widthMeasureSpec, (-16777216) & childState4);
        int height = View.resolveSizeAndState(childState5, heightMeasureSpec, childState4 << 16);
