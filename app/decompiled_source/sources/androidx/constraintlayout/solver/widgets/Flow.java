    ...
    private void measureChainWrap(ConstraintWidget[] widgets, int count, int orientation, int max, int[] measured) {
        ...
        for (int i6 = 0; i6 < listCount; i6++) {
            ...
            if (orientation == 0) {
                ...
                ConstraintAnchor currentBottom2 = bottom3;
                current2.setup(orientation, top3, top2, currentBottom2, bottom2, paddingLeft2, paddingTop2, paddingRight2, paddingBottom2, max);
                top2 = currentBottom;
                paddingTop2 = 0;
                ...
                ConstraintAnchor currentRight2 = bottom2;
                current2.setup(orientation, top3, top2, bottom3, currentRight2, paddingLeft2, paddingTop2, paddingRight2, paddingBottom2, max);
                top3 = currentRight;
                paddingLeft2 = 0;
