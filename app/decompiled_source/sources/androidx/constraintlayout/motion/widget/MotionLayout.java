    ...
    class DecelerateInterpolator extends MotionInterpolator {
        ...
        public float getInterpolation(float time) {
            ...
            if (f > 0.0f) {
                ...
                float pos = (f3 * time) - (((f4 * time) * time) / 2.0f);
            ...
            float pos3 = (f6 * time) + (((f7 * time) * time) / 2.0f);
    ...
    */
    ...
    public class Model {
        ...
        public void measure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            int height2 = (MotionLayout.this.mHeightMeasureMode == Integer.MIN_VALUE || MotionLayout.this.mHeightMeasureMode == 0) ? (int) (MotionLayout.this.mStartWrapHeight + (MotionLayout.this.mPostInterpolationPosition * (MotionLayout.this.mEndWrapHeight - MotionLayout.this.mStartWrapHeight))) : height;
            ...
            MotionLayout.this.resolveMeasuredDimension(widthMeasureSpec, heightMeasureSpec, width, height2, isWidthMeasuredTooSmall, isHeightMeasuredTooSmall);
        }
    ...
    private class DevModeDraw {
        ...
        private void drawPathRelativeTicks(Canvas canvas, float x, float y) {
            ...
            String text = BuildConfig.FLAVOR + (((int) ((len * 100.0f) / dist)) / 100.0f);
        ...
        private void drawPathCartesianTicks(Canvas canvas, float x, float y) {
            ...
            String text = BuildConfig.FLAVOR + (((int) (((xgap * 100.0f) / Math.abs(x2 - x1)) + 0.5d)) / 100.0f);
            getTextBounds(text, this.mTextPaint);
            ...
            String text2 = BuildConfig.FLAVOR + (((int) (((ygap * 100.0f) / Math.abs(y2 - y1)) + 0.5d)) / 100.0f);
        ...
        private void drawPathScreenTicks(Canvas canvas, float x, float y, int viewWidth, int viewHeight) {
            String text = BuildConfig.FLAVOR + (((int) ((((x - (viewWidth / 2)) * 100.0f) / (MotionLayout.this.getWidth() - viewWidth)) + 0.5d)) / 100.0f);
            getTextBounds(text, this.mTextPaint);
            ...
            String text2 = BuildConfig.FLAVOR + (((int) ((((y - (viewHeight / 2)) * 100.0f) / (MotionLayout.this.getHeight() - viewHeight)) + 0.5d)) / 100.0f);
            getTextBounds(text2, this.mTextPaint);
