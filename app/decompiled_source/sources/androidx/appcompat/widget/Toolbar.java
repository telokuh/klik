...
public class Toolbar extends ViewGroup {
    ...
    */
    public void onLayout(boolean changed, int l, int t, int r, int b) {
            ...
            if (!layoutSubtitle || this.mSubtitleTextView.getMeasuredWidth() <= 0) {
                ...
                if (isRtl) {
                    ...
                    if (layoutSubtitle) {
                        ...
                        this.mSubtitleTextView.layout(subtitleRight2 - this.mSubtitleTextView.getMeasuredWidth(), titleTop4, subtitleRight2, subtitleBottom2);
        ...
        int centerLeft3 = 0;
        for (int centerViewsCount = this.mTempViews.size(); centerLeft3 < centerViewsCount; centerViewsCount = centerViewsCount) {
            centerLeft2 = layoutChildLeft(this.mTempViews.get(centerLeft3), centerLeft2, collapsingMargins, alignmentHeight3);
            centerLeft3++;
        }
