    ...
    private void onMeasureExactFormat(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        while (true) {
            ...
            if (child.getVisibility() == 8) {
                ...
                int cellsUsed = measureChildForCells(child, cellSize2, cellsAvailable, itemHeightSpec, heightPadding2);
            ...
            while (i4 < childCount) {
                ...
                if ((minCellsAt & minCellsItemCount3) == 0) {
                    ...
                    if (centerSingleExpandedItem && lp3.preventEdgeOffset && maxCellsUsed == 1) {
                        ...
                        child2.setPadding(i5 + cellSize2, 0, i5, 0);
                    }
                    lp3.cellsUsed++;
                    lp3.expanded = true;
                    maxCellsUsed--;
        ...
        if (maxCellsUsed <= 0 || smallestItemsAt == 0) {
            cellSize = cellSize2;
        } else if (maxCellsUsed < maxChildHeight2 - 1 || singleItem || expandableItemCount > 1) {
            ...
            int extraPixels = expandCount > 0.0f ? (int) ((maxCellsUsed * cellSize) / expandCount) : i;
            int i6 = 0;
            while (i6 < childCount) {
                boolean singleItem2 = singleItem;
                float expandCount2 = expandCount;
                if ((smallestItemsAt & (1 << i6)) != 0) {
        ...
        if (needsExpansion) {
            for (int i7 = 0; i7 < childCount; i7++) {
                ...
                if (lp5.expanded) {
                    ...
                    child4.measure(View.MeasureSpec.makeMeasureSpec(width, BasicMeasure.EXACTLY), itemHeightSpec);
                }
            }
        }
