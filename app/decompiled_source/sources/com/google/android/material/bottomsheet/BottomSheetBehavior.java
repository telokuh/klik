...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
                    ...
                    if (top5 != 0 && Math.abs(xvel) <= Math.abs(yvel)) {
                        ...
                        if (BottomSheetBehavior.this.fitToContents) {
                            ...
                            if (currentTop2 < Math.abs(currentTop2 - BottomSheetBehavior.this.collapsedOffset)) {
                                int top10 = BottomSheetBehavior.this.expandedOffset;
                                top = top10;
                                targetState = 3;
                            } else {
    ...
    private int calculatePeekHeight() {
        ...
        if (this.peekHeightAuto) {
            ...
            return Math.min(desiredHeight, this.childHeight);
        } else if (!this.gestureInsetBottomIgnored && (i = this.gestureInsetBottom) > 0) {
