...
public final class MaterialContainerTransform extends Transition {
    ...
    private static final class TransitionDrawable extends Drawable {
        ...
        private void updateProgress(float progress) {
            ...
            float currentElevationDx = (int) (f * dxMultiplier);
            this.currentElevationDy = (int) (f * dyMultiplier);
            this.shadowPaint.setShadowLayer(f, currentElevationDx, this.currentElevationDy, SHADOW_COLOR);
            ...
            this.fadeModeResult = this.fadeModeEvaluator.evaluate(progress, fadeStartFraction, fadeEndFraction);
